...
])), new Button(new Vector(250, 500), new Vector(0, -1), 5), new SimpleObstacle(new ConvexPolygonCollider([
...
// Aesthetics
new Light(new Vector(170, 170)), new Light(new Vector(250, 600)), new Light(new Vector(500, 300)));
for (let i = 0; i < 3; i++) {
